...
echo mail.smtp.host=$mail_smtp_host >> $JBOSS_HOME/standalone/deployments/lpd_web.properties
echo mail.smtp.user=$mail_smtp_user >> $JBOSS_HOME/standalone/deployments/lpd_web.properties
